...
@Component({
    standalone: true,
    selector: 'session-icon',
    template: `
        <svg fill="#3584e4" width="100px" height="100px" viewBox="0 0 512 512" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                ></path>
                <path d="M160.41,355.29H113.64a4.53,4.53,0,0,0,0,9.06h46.77a4.53,4.53,0,0,0,0-9.06Z"></path>
            </g>
        </svg>
    `,
})
